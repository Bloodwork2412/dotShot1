...
import 'package:dot_shot/src/main_menu/main_menu.dart';
import 'package:dot_shot/src/play_session/game_screen.dart';
...
// all routes used in this game
class MyApp extends StatelessWidget {
  static final _router = GoRouter(
    routes: [
      GoRoute(path: '/', builder: (context, state) => MainMenu(key: Key('main menu')), routes: [
        GoRoute(
          path: 'session/:level',
          pageBuilder: (context, state) {
            ...
            return buildMyTransition(
              ...
              color: context.watch<Palette>().background,
            );
          },
        ),
        GoRoute(
